...
import zhCN_Date from "bee-datepicker/build/locale/zh_CN";
import zhTW_Date from 'bee-datepicker/build/locale/zh_TW';
import enUS_Date from 'bee-datepicker/build/locale/en_US';
...
let locale =  (getCookie('locale')||navigator.language.split('_')[0].replace(/-/,'_')||"zh_CN")
