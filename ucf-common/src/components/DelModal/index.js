                ...
                >
...

                    {
                        showFooter ? (<Modal.Footer>
                            <Button onClick={this.close} iconType="uf-correct" size='sm' colors="primary" style={{ 'marginRight': '15px' }}>{cancelFnName}</Button>
                            <Button onClick={this.onConfirm} iconType="uf-close" size='sm' colors="primary">{confirmName}</Button>
                        </Modal.Footer>) : ''
                    }
                </Modal>
            </span>
